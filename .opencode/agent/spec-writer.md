...
Rules:
- Every test must cite the spec line it encodes, as a comment: `// per spec.md:L42`
- Every test must cite any blueprint/spec doc it references: `// per __CITATION_PREFIX__SPEC.md:5`
