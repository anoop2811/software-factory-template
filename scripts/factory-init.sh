...
cp "$TEMPLATE_DIR/scripts/lib/budget-config.sh" "$TARGET_DIR/scripts/lib/"
cp "$TEMPLATE_DIR/scripts/lib/loop.py" "$TARGET_DIR/scripts/lib/"
...
cp "$TEMPLATE_DIR/scripts/factory-loop.sh" "$TARGET_DIR/scripts/"
...
cp "$TEMPLATE_DIR/docs/LOOPS.md" "$TARGET_DIR/docs/"
...
chmod +x "$TARGET_DIR/scripts/factory-loop.sh"
